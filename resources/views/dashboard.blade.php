        ...
        <div class="w-6x1 mx-auto hx-auto sm:px-6 container">
            <div class=" bg-gray-100 overflow-hidden shadow-xl sm:rounded-lg text-start flex p-6 h-4x1" >
                ...
                <div class="terreno flex-1 m-1" >
                    ...
                    <ul class="space-y-1 text-center m-1">

                        <li><button type="button" class="btn btn-dark btn-lg btn-block"><a href="{{ route('plantas.create') }}" class="text-white ">Registrar una planta</a></button></li>
                        <li><button type="button" class="btn btn-dark btn-lg btn-block"><a href="{{ route('plantas.index') }}" class="text-white ">Listado de plantas</a></button></li>
                        <li><button type="button" class="btn btn-dark btn-lg btn-block"><a href="{{ route('terrenos.create') }}" class="text-white ">Crear un nuevo terreno</a></button></li>
                        <li><button type="button" class="btn btn-dark btn-lg btn-block"><a href="{{ route('terrenos.index') }}" class="text-white ">Consultar un terreno</a></button></li>
                ...
                <div class="ganado flex-1 m-1">
                    ...
                    <ul class="space-y-1 text-center">
                        ...
                        <li><button type="button" class="btn btn-dark btn-lg btn-block" ><a href="{{ route('production.index') }}" class="text-white">Producción</a></button></li>
                        <li><button type="button" class="btn btn-dark btn-lg btn-block"><a href="{{ route('healths.index') }}" class="text-white">Sanidad</a></button></li>
                        <li><button type="button" class="btn btn-dark btn-lg btn-block"><a href="{{ route('foods.index') }}" class="text-white">Comida</a></button></li>
