        ...
        <div class="card container w-40 align-self-center">
            <div class="row p-3">
                ...
                <div class="texto align-self-center col-7 ">
                    ...
                    <h2 class="h6 text-center"><p class="hidden">{{ $animal->genero }}</p>@if ( $animal->genero==1)
                        <h6 class="h6 text-center">Su genero es: Macho</h6>
                    @else
                        <h6 class="h6 text-center">Su genero es: Hembra</h6>
                    @endif </h2>
